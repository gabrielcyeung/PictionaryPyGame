...
while playing== True:
    ...
    if state==1:
        ...
        if player_delay<720:            
            ...
            player_surface=biggest_font.render("Player "+player+"'s turn", True, BLUE)
            screen.blit(player_surface, (145,200))
            other_player_surface=bigger_font.render("Other player look away!", True, WATER)
            screen.blit(other_player_surface, (140, 255))
            player_delay+=1
        else:
            screen.fill(BEIGE)
    ...
    if state==2:
        ...
        #Timer bar
        pygame.draw.rect(screen,BLACK,(170,450,300,10),1)
