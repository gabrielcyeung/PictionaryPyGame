...
colour_list=[BLACK,WHITE,RED,LIME,BLUE,GREEN,AQUA,WATER,FUCHSIA,PURPLE,YELLOW,ORANGE,BEIGE,BROWN]
...
while playing== True:
    ...
    if state==0:
        ...
        #Coder
        author=font_small_bold.render("Game designed and coded by Gabriel Yeung", True, WATER)
    ...
    if state==2:
        ...
        if pygame.mouse.get_pressed()[0]:
            ...
            if mouse_position[0]>600 and mouse_position[0]<620 and mouse_position[1]>120 and mouse_position[1]<390.76:
                #print "TRUE. Mouse on colour bar"
                ...
                #print "FALSE. Mouse not on colour bar"
                pygame.draw.circle(screen,colour,(mouse_position),5)       

        #Right click --> to erase
        if pygame.mouse.get_pressed()[2]:
           pygame.draw.circle(screen,BEIGE,(mouse_position),5)          
    ...
    if state==3:
        ...
        rule_f=font.render("-Left click to draw", True, WATER)
        rule_g=font.render("-Right click to erase", True, WATER)
        rule_h=font.render("Click the floppy disk to save image (save's one drawing only)", True, WATER)
        #Render text
        ...
        screen.blit(rule_g,(100,300))
        screen.blit(rule_h,(100,320))                
        screen.blit(rule_e,(100,340))
