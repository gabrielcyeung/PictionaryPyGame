...
from random_num import randomizer
pygame.init()
...
while playing== True:
    ...
    if state==2:
        ...
        pygame.draw.rect(screen, BLACK, (600,10,20,250), 2)
        ...
        #Rectangle dimensons (600<x<610, 10<y<260)
        if mouse_position>(600,20) and mouse_position(610,260):
            print "TRUE"'''
        #black
